...
struct Material {
	Material( Colour ambient, Colour diffuse, Colour specular, double exp, double damp, double refraction) :
		ambient(ambient), diffuse(diffuse), specular(specular), 
		specular_exp(exp), damp_factor(damp), refraction_factor(refraction){}
